	...
	return []*framework.Path{
		{
			...
			Operations: map[logical.Operation]framework.OperationHandler{
				logical.ReadOperation: &framework.PathOperation{
					Callback: b.staticRoleReadOperation,
				},
			...
			HelpDescription: "Create, read, update, or delete static roles. Reading a role generates a new bearer token from PingFederate.",
		},
		{
...
func (b *pingFederateBackend) staticRoleReadOperation(ctx context.Context, req *logical.Request, d *framework.FieldData) (*logical.Response, error) {
	name, ok := d.Get("name").(string)
	if !ok {
